                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Lifestyle</span>
                      <a href="post-details.html"><h4>Its Good The Beautiful Feature</h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>
                      ...
                      <div class="post-options">
                        <div class="row">
                          <div class="col-6">
                            <ul class="post-tags">
                              <li><i class="fa fa-tags"></i></li>
                              <li><a href="#">Brazilian the good football</a>,</li>
                            </ul>
                          </div>
                          <div class="col-6">
                            <ul class="post-share">
                      ...
                      <div class="post-options">
                        <div class="row">
                          <div class="col-6">
                            <ul class="post-tags">
                              <li><i class="fa fa-tags"></i></li>
                              <li><a href="#">Indonesia its beutyful Country</a>,</li>
